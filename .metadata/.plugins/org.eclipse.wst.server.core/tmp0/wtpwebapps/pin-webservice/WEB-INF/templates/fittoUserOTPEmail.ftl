<html>
    ...
    <body>
        <table align="center" width="80%">
            <tr align="center">
                <!-- <td><img style=" width: 200px; height: 200px;" src="${orgLogoUrl}" alt="Logo"/></td> -->
            </tr>
           ...
           <tr align="center">
                <td><span style="font: 22px Helvetica;">Thank you for registering with us! </span></td>
            </tr>
             <tr><td style="font-size: 0; line-height: 0;" height="50">&nbsp;</td></tr>
            <tr align="center">
                <td><span style="font: 22px Helvetica;">Your OTP is ${otp} for creation of the login ID ${patientUserId} </span></td>
            </tr>
            ...
            <tr align="center" style="border: 1px solid #4267B343;">
                <table align="center" style="background-color: #4267B343; border: 1px solid #4267B343;" width="100%">
                    <tr>
                        <td align="center">
                            <span style="font: 16px Helvetica;">Click the link to see the <a href="${tncUrl}">Terms & Conditions</a></span>
                        </td>
                    </tr>
                    <!-- <tr><td style="font-size: 0; line-height: 0; border-bottom: 1px solid #707070;" height="30">&nbsp;</td></tr> -->
                    <tr><td style="font-size: 0; line-height: 0;" height="10">&nbsp;</td></tr>
                    ...
                    <tr>
                        <td align="center"><span style="font: 16px Helvetica;"></span></td>
                    </tr>
                    <tr>
                        <td align="center"> <span style="font: 5px Helvetica;">Please check your SPAM Folder</span></td>
                    </tr>
                    <!-- <tr>
                        <td align="center"><span style="font: 16px Helvetica;"><a href="#">Unsubscribe</a></span></td>
                    </tr> -->
                    <tr>
