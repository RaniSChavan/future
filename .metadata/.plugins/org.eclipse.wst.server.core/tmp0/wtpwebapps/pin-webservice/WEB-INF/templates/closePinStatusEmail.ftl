    ...
    <body>
        <table align="left" width="100%">
            ...
            <tr><td style="font-size: 0; line-height: 0;" height="50">&nbsp;</td></tr>
	            <tr align="left">
	                <td><span style="font: 18px Helvetica;">Close Pin Request has been ${statusText} for the project ${projectName}.</span></td>
	            </tr>
				<tr align="left">
					<td><span style="font: 18px Helvetica;">Please find the below information for the Close Pin Request.</span></td>
